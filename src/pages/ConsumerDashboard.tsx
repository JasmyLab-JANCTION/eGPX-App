...
export default function ConsumerDashboard({
  ...
  const [twoFactorEnabled, setTwoFactorEnabled] = useState(
    mockUserProfile.twoFactorEnabled,
  );
  ...
  useEffect(() => {
    if (selectedTask) {
      setSelectedTask((current) =>
        videoRenderingTasks.find((val) => val.id === current.id),
      );
    }
  }, [videoRenderingTasks]);
    ...
    if (isCompleted) {
      return (
        <Dialog
          ...
          onClose={handleCloseThreadDetails}
          maxWidth="sm"
          fullWidth
        >
          <DialogTitle>
            ...
            <Typography
              sx={{ fontSize: "0.875rem", color: COLORS.slate, mt: 0.5 }}
            >
                ...
                return (
                  <Accordion
                    ...
                    onChange={(_, isExpanded) =>
                      setExpandedTaskId(isExpanded ? task.id : false)
                    }
                    disableGutters
                    sx={{
                      border: `1px solid ${COLORS.border}`,
                  ...
                  >
                    ...
                    <AccordionDetails sx={{ bgcolor: COLORS.white }}>
                      ...
                      >
                              ...
                              >
                                ...
                                <TableCell>
                                  <Button
                                    size="small"
                                    onClick={() =>
                                      handleViewThreadDetails(task, th)
                                    }
                                    sx={{
                                      textTransform: "none",
                                      fontSize: "0.8125rem",
                        ...
                        {task.solutionZip && task.solutionZip.url && (
                          <Table size="small">
                            <TableRow>
                              <TableCell>
                                <Button
      ...
      case "network":
        return (
          <Box>
            ...
            <Typography
              sx={{ fontSize: "0.9375rem", color: COLORS.slate, mb: 4 }}
            >
              ...
              <Grid item xs={12} md={6}>
                <Paper sx={{ p: 4 }}>
                  ...
                  <Box sx={{ mb: 3 }}>
                    ...
                    />
                    <Typography
                      sx={{ fontSize: "0.75rem", color: COLORS.slate, mt: 0.5 }}
                    >
                  ...
                  <Box
                    sx={{
                      ...
                      bgcolor: twoFactorEnabled
                        ...
                        : "#F8F9FA",
                      borderRadius: 1,
                      border: `1px solid ${twoFactorEnabled ? COLORS.green : COLORS.border}`,
                    }}
                  >
                    <FormControlLabel
                      control={
